#!/bin/bash
# mythlink.sh written by Justin Decker, copyright 2015. For licensing purposes, use GPLv2
#
# To use, create a "recording started" event that runs like so: /path/to/script/mythlink.sh "%CHANID%" "%STARTTIMEUTC%"
